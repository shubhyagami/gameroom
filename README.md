...
- Write clear commit messages and include tests for any logic changes.  
- Open a Pull Request against `main`, referencing related issues with `Closes #<number>`.  
...
- **Discord (optional):** https://discord.gg/gameroom  
